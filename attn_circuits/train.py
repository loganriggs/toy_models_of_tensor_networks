...
def main():
    ...
    for step in range(args.num_steps):
        ...
        if step % args.eval_interval == 0 and step > 0:
            ...
            with torch.no_grad():
                for _ in range(20):
                    if val_cache_tokens is not None:
    ...
    tag = f'{lang_tag}{args.rules}_{args.n_layer}L_{args.n_head}H_d{args.n_embd}_{args.num_steps}steps'
